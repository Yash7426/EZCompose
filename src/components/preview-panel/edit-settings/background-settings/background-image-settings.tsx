...
interface BackgroundImageSettingsProps {
    ...
    setBackgroundSettings: React.Dispatch<React.SetStateAction<IBackgroundSettings>>
    setBgImg: () => void;
}
enum loadType{
    "curated",
...
type IrepeatOptionsType="repeat" | "repeat-x" | "repeat-y" | "no-repeat" | "space" | "round";

type IreturnType = "Loading..." | "Popular Images" | "Something went wrong!" | `Currently showing: ${string}`;
...
const BackgroundImageSettings: React.FC<BackgroundImageSettingsProps> = (props) => {
 ...
 setImageSearchSetting({
    ...
    const updateBGPath = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        ...
        props.setBackgroundSettings((prev) => ({ ...prev, backgroundImage: { ...props.backgroundSettings.backgroundImage, url: __iPath|| "" } }));
        setImageSearchSetting({ ...imageSearchSetting, panelMode: 2 });
    }
  

    interface SelectProps<T extends string | number | readonly string[] | undefined> {
 ...
 const repeatOptions:Array<{
        ...
        { value: "repeat", label: "Repeat Both", isSelected: props.backgroundSettings.backgroundImage.repeat === "repeat" },
        { value: "repeat-x", label: "Horizontal Repeat", isSelected: props.backgroundSettings.backgroundImage.repeat === "repeat-x" },
        { value: "repeat-y", label: "Vertical Repeat", isSelected: props.backgroundSettings.backgroundImage.repeat === "repeat-y" },
        { value: "no-repeat", label: "Do not repeat", isSelected: props.backgroundSettings.backgroundImage.repeat === "no-repeat" },
        { value: "space", label: "Space", isSelected: props.backgroundSettings.backgroundImage.repeat === "space" },
        { value: "round", label: "Round", isSelected: props.backgroundSettings.backgroundImage.repeat === "round" }
    ];

const PanelOptions = [
    { value: 0, label: "Online Images", isSelected: imageSearchSetting.panelMode === 0 },
    { value: 1, label: "Custom Image", isSelected: imageSearchSetting.panelMode === 1 },
    { value: 2, label: "Settings", isSelected: imageSearchSetting.panelMode === 2 }
];

const backGroundPositions= [
 { value: positionLeft.left, label: "Left", isSelected: props.backgroundSettings.backgroundImage.positionLeft === positionLeft.left },
{ value: positionLeft.center, label: "Center", isSelected: props.backgroundSettings.backgroundImage.positionLeft === positionLeft.center },
   { value: positionLeft.right, label: "Right", isSelected: props.backgroundSettings.backgroundImage.positionLeft === positionLeft.right },
   { value: positionLeft.custom, label: "Custom", isSelected: props.backgroundSettings.backgroundImage.positionLeft === positionLeft.custom }
];
const backGroundImageSize= [
 { value: size.auto, label: "Auto", isSelected: props.backgroundSettings.backgroundImage.size === size.auto },
{ value: size.cover, label: "Cover", isSelected: props.backgroundSettings.backgroundImage.size === size.cover },
  { value: size.contain, label: "Contain", isSelected: props.backgroundSettings.backgroundImage.size === size.contain },
  { value: size.custom, label: "Custom", isSelected: props.backgroundSettings.backgroundImage.size === size.custom }
 ]
 const BackgroundPositionsVertical= [
    { value: positionTop.top, label: "Top", isSelected: props.backgroundSettings.backgroundImage.positionTop === positionTop.top },
    { value: positionTop.center, label: "Center", isSelected: props.backgroundSettings.backgroundImage.positionTop === positionTop.center },
    { value: positionTop.bottom, label: "Bottom", isSelected: props.backgroundSettings.backgroundImage.positionTop === positionTop.bottom },
    { value: positionTop.custom, label: "Custom", isSelected: props.backgroundSettings.backgroundImage.positionTop === positionTop.custom }
];
const BackgroundAttachment=[
  { value: attchement.fixed, label: "Parallax", isSelected: props.backgroundSettings.backgroundImage.attchement === attchement.fixed },
{ value: attchement.initial, label: "No Parallax", isSelected: props.backgroundSettings.backgroundImage.attchement === attchement.initial }
]
  
const Select = <T extends string | number | readonly string[] | undefined> ({ options, onSelect }: SelectProps<T>) => {
    return (
                ...
                <ul>
                    {
                        PanelOptions.map((option, index) => (
                            <li
                                ...
                                onClick={() => setImageSearchSetting({ ...imageSearchSetting, panelMode: option.value })}
                            >
                                {option.label}
                            </li>
                        ))
            ...
            <div className='bgPanelSec'>
                ...
                {(imageSearchSetting.panelMode === 0) && <div className='pexelSearchImg'>
                    ...
                    <div className='bgImageSearchbar'>
                        <input className={"sbarImg"} type={"text"} onKeyDown={(e) => { 
                            if (e.key === "Enter") { loadImages(loadType.search) } }}
                             onChange={(e) => setImageSearchSetting({ ...imageSearchSetting, q: e.target.value })}
                              placeholder="Search images..">

                              </input>
                        <button className='ImgSearchAct' onClick={() => loadImages(loadType.search)}>
                    ...
                    <div className='applySearchBG'>
                        <Link href="https://www.pexels.com" target={"_blank"} className="pexels_credit">
                ...
                {(imageSearchSetting.panelMode === 1) && <div className='userOwnImg'>
                    <div className='bgImageCustom'>
                        ...
                        <button className='imgCusAct' onClick={() => {
                            props.setBackgroundSettings((prev) => ({ ...prev, backgroundImage: { ...prev.backgroundImage, url: imageSearchSetting.cURI } }))
                            setImageSearchSetting({ ...imageSearchSetting, panelMode: 2 });
                            props.setBgImg()
                        }}> Apply</button>
                    </div>
                ...
                {(imageSearchSetting.panelMode === 2) && <div className='bgImgSettings'>
                    ...
                    <div className='imageSettingsOption'>
                        ...
                        <Select options={backGroundImageSize } onSelect={(value) => props.setBackgroundSettings({ ...props.backgroundSettings, backgroundImage: { ...props.backgroundSettings.backgroundImage, size: value } })} />


                        {(props.backgroundSettings.backgroundImage.size === size.custom) && <div className='customImgSizes'>
                    ...
                    <div className='imageSettingsOption'>
                        <Select options={BackgroundAttachment}
                         onSelect={(value) => props.setBackgroundSettings(
                            { ...props.backgroundSettings,
                          backgroundImage: { ...props.backgroundSettings.backgroundImage, 
                          attchement: value }
                           })} />
                    </div>
                    ...
                    <div className='imageSettingsOption'>
                        <div className='imagePosSort'>
                            <div className='ImgHorzPs'>
                                ...
                                onSelect={(value) => props.setBackgroundSettings({ ...props.backgroundSettings, backgroundImage: { ...props.backgroundSettings.backgroundImage, positionLeft: value } })} />

                                {(props.backgroundSettings.backgroundImage.positionLeft === positionLeft.custom) && <div className='customImgSizes'>
                                    <div className='colorPalletStrength dircol'>
                                        <input className='colorPalletOpacityRange' type={"range"} onChange={(e) => props.setBackgroundSettings({ ...props.backgroundSettings, backgroundImage: { ...props.backgroundSettings.backgroundImage, posX: Number(e.target.value) } })}
                            ...
                            <div className='ImgVertPs'>
                                ...
                                <Select
                                 ...
                                 />
                                {(props.backgroundSettings.backgroundImage.positionTop === positionTop.custom) && <div className='customImgSizes'>
                                    <div className='colorPalletStrength dircol'>
                                        <input className='colorPalletOpacityRange' type={"range"} onChange={(e) => props.setBackgroundSettings({ ...props.backgroundSettings, backgroundImage: { ...props.backgroundSettings.backgroundImage, posY: Number(e.target.value) } })}
                    ...
                    <Select options={repeatOptions}
                     onSelect={(value) => props.setBackgroundSettings({ ...props.backgroundSettings,
                      backgroundImage: { ...props.backgroundSettings.backgroundImage, repeat: value } })}
                       />
