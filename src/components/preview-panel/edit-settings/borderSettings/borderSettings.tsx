...
export default function BorderSettings(props:Allow) {
    ...
    const [borderDetails, setBorderDetails] = useState<IBorderDetails>({
        lockedAll: true,
        borderTop: {
            color: '#000000',
            thickness: 2,
    ...
    const setBorderType = (val:string) => {
        if (borderDetails.lockedAll) {
            setBorderDetails({
                ...borderDetails,
