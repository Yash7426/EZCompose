 ...
 * Panels
 */
import BackgroundSetting from './background-settings/background-setting';
...
interface iProps{
    closePanel: () => void,
    currentlyActive :React.MutableRefObject<null>
}
const EditSettings:React.FC<iProps>=(props) =>{
