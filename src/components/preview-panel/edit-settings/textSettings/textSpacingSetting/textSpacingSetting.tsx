...
interface ITextSpacingSetting {
    textSetting: TextSetting;
    setTextSetting: React.Dispatch<React.SetStateAction<TextSetting>>;
    applyFormattingStyle: () => void;
}
export default function TextSpacingSetting({ textSetting, setTextSetting, applyFormattingStyle }: ITextSpacingSetting) {
    return (
        <>
