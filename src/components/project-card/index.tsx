...
const ProjectCard: React.FC<BlogCardProps> = ({ imageUrl, title, description, link }) => {
    return (
        <div className="hover:scale-110 transition duration-200 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <Link href={link}>
