        ...
        <div className='layoutCreator'>
            ...
            <div className='webSettingPanel'>
                <div className="webSettingInner">
                    <div className={(pageDesignState.design?.isPublished) ? "websiteUnpublish" : "websitePublished"}>
                        <span> This page is {(pageDesignState.design?.isPublished) ? "Live" : "unpublished"} </span>
                        <button onClick={pageDesignState.publishWebPage} className={(pageDesignState.design?.isPublished) ? "unpublish" : ""}>{(pageDesignState.design?.isPublished) ? "Unpublish" : "Publish"}</button>
                    </div>
                    ...
                    <div className='websiteSettingsPanelInner'>
                        ...
                        <div className='all_prev'>
                            <div className='tab_prev'>
                                ...
                                <img className='tab_favico'
                                 src={(pageDesignState.design && pageDesignState.design.websiteSetting && pageDesignState.design.websiteSetting.favIco.length > 0) ? pageDesignState.design.websiteSetting.favIco : "/assets/images/tabPrev/noFav.JPG"} />
                        ...
                        <div className='inputWebSet favIcoFlex'>
                            ...
                            <input type="text"
                             onChange={(e) => 
                                pageDesignState.setDesign({ ...pageDesignState.design,
                                websiteSetting: { ...pageDesignState.design?.websiteSetting,
                                favIco: e.target.value 
                                } })
                            }
                              value={pageDesignState.design?.websiteSetting?.favIco}>
                              </input>
                        </div>
                        <hr />
                        ...
                        <div className='inputWebSet'>
                            ...
                            value={pageDesignState.design?.websiteSetting?.siteName}></input>
                        </div>
                        <div className='inputWebSet'>
                                ...
                                pageDesignState.setDesign({ ...pageDesignState.design,
                                 websiteSetting: { ...pageDesignState.design?.websiteSetting,
                                  desc: e.target.value
                                   ...
                                   value={pageDesignState.design?.websiteSetting?.desc}>
                            </input>
                        </div>
