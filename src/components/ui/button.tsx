...
const variants= {
  ...
  outline:"shadow-[0_0_0_3px_#000000_inset] px-6 py-2 bg-transparent hover:border-black hover:text-black border border-black dark:border-white dark:text-white text-black rounded-lg font-bold transform hover:bg-white transition duration-500"
}
